...
api_urls = [
    ...
    url(r'^/friends/reject_request(?:/(?P<username>\w+))?$', AcceptRequest.as_view(), name = 'accept_request'),
    url(r'^/friends/accept_request(?:/(?P<username>\w+))?$', RejectRequest.as_view(), name = 'reject_request')
]
